...
export function SettingsHowToAnnouncement() {
  const t = useTheme()
  const {_} = useLingui()
  ...
  return (
    <Dialog.Outer
      ...
      <Dialog.ScrollableInner
        label={_(msg`Introducing... TV Time!`)}
        ...
        <View
          ...
          <View
            ...
            <Text
              ...
              <Trans>TV Time Exclusive</Trans>
            </Text>
          </View>
          <Image
            accessibilityIgnoresInvertColors
            source={require('../../../../assets/images/tv_settings_nux.png')}
            style={[
              a.w_full,
              {
                aspectRatio: 393 / 226,
        ...
        <View style={[a.align_center, a.px_xl, a.pt_xl, a.gap_2xl, a.pb_sm]}>
          <View style={[a.gap_sm, a.align_center]}>
            ...
            <Text
              ...
              <Trans>
                You can now add custom verifiers, alter egos, hide suggested
                accounts, uncap the labeler limit and much more to come!
              </Trans>
            </Text>
          </View>
