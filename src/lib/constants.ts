...
export const BSKY_SERVICE = 'https://castletown.darkworld.download' // 'https://bsky.social'
export const DARKWORLD_SERVICE = 'https://castletown.darkworld.download'
...
export function FEEDBACK_FORM_URL({
  ...
  let _email = email
  let _handle = handle
  return 'https://tangled.org/did:plc:s7cesz7cr6ybltaryy4meb6y/BlueskyOnCrack/issues'
}
