...
} from '#/alf/crack/blackskyColorGeneration'
import {
...
} from '#/alf/crack/deerColorGeneration'
...
export const CUSTOM_THEME_SCHEMES = [
  'witchsky',
  'bluesky',
  'blacksky',
  'deer',
...
export type CustomThemeScheme = (typeof CUSTOM_THEME_SCHEMES)[number]

export const customSchemes: Record<CustomThemeScheme, typeof themes> = {
  witchsky: witchskyscheme,
  bluesky: blueskyscheme,
  blacksky: blackskyscheme,
  deer: deerscheme,
  zeppelin: zeppelinscheme,
  kitty: kittyscheme,
  reddwarf: reddwarfscheme,
  catppuccin: catppuccinscheme,
  evergarden: evergardenscheme,
}

export function selectScheme(
  scheme: CustomThemeScheme | undefined,
): typeof themes {
  return customSchemes[scheme ?? 'catppuccin'] ?? catppuccinscheme
}
