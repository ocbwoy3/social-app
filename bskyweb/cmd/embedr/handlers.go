...
func (srv *Server) WebOEmbed(c echo.Context) error {
	...
	data := OEmbedResponse{
		...
		AuthorURL:    fmt.Sprintf("https://tvworld.darkworld.download/profile/%s", post.Author.Handle),
		ProviderName: "It's TV Time!!",
		ProviderURL:  "https://tvworld.darkworld.download",
		CacheAge:     86400,
		Width:        &width,
		Height:       nil,
		HTML:         html,
